        ...
        while(week<=amountOfWeeksSimulation){
            ...
            {// lengthDay --> opnieuw bekijken want je kan op halve ook nog bellen --> oplossing zoeken 
                ...
                if((day!=6)&&(callTime<arrivalTimeUrgent)){
                    ...
                    double rest = nieuwePatient.getAppointmenttime()%2;
        
                    if(rest==0){ //scheduled slot is 0, 30, 60, 90, ...
                        nieuwePatient.setScheduleTimeElective(nieuwePatient.getAppointmenttime());
                    }
                    ...
                    double rest2 = nieuwePatient.getAppointmenttime()%2;
        
                    if(rest2==0){ //scheduled slot is 0, 30, 60, 90, ...
                        nieuwePatient.setScheduleTimeElective(nieuwePatient.getAppointmenttime());
                    }
                    else{ //scheduled slot is 15, 45, 75, ...
                        nieuwePatient.setScheduleTimeElective(nieuwePatient.getAppointmenttime()-15);
